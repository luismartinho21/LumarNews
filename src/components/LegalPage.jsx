    ...
    <div className="legal-page glass-panel">
      ...
      {isPrivacy ? (
        <div className="legal-content">
          ...
          <h3>1. Introdução</h3>
          <p>O LumarNews ("nós", "nosso") respeita a sua privacidade. Esta Política de Privacidade explica como recolhemos, usamos e protegemos a sua informação quando visita a nossa aplicação web.</p>

          <h3>2. Recolha e Uso de Dados</h3>
          <p>Não recolhemos dados pessoais sensíveis, como nomes, moradas ou números de telefone. A nossa aplicação é um agregador de feeds RSS públicos.</p>

          <h3>3. Uso de Armazenamento Local (Cookies e LocalStorage)</h3>
          <p>Utilizamos o <strong>LocalStorage</strong> do seu navegador web para:</p>
          <ul>
            <li>Guardar as suas preferências de tema e fontes de notícias.</li>
            <li>Guardar uma cache local das últimas notícias lidas, de modo a poupar dados móveis e acelerar a navegação.</li>
        ...
        <div className="legal-content">
          ...
          <p>Ao aceder à aplicação LumarNews, o utilizador concorda em cumprir estes Termos e Condições de uso. Se não concordar com alguma parte destes termos, não deve utilizar o serviço.</p>
