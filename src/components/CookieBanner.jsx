  ...
  return (
    <div className="cookie-banner glass-panel">
      <div className="cookie-content">
        ...
        <p>
          Utilizamos armazenamento local (LocalStorage) para guardar as suas
          preferências e otimizar o carregamento das notícias. Ao clicar em
          "Aceitar", concorda com a nossa{" "}
          <button className="link-btn" onClick={onReadMore}>
      ...
      <div className="cookie-actions">
        <button className="btn btn-outline" onClick={declineCookies}>
          Recusar
        </button>
