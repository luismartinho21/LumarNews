export const getFallbackImage = (category) => {
  ...
  if (
    ...
    cat.includes("cinema") ||
    cat.includes("música") ||
    cat.includes("televisão") ||
    cat.includes("famosos")
  ) {
